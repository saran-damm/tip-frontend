...
export default function Home() {
  ...
  className="px-4 py-2 rounded-md text-sm font-medium transition btn-primary"
>
  Logout
</button>
      </div>
      <div className="flex-1 flex items-center justify-center">
        <div className="w-full max-w-5xl px-6">
          <h1 className="text-5xl text-center font-extrabold text-slate-800 mb-12">
          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-start gap-8 justify-center">
            <div className="flex-1 flex justify-center">
              <Card
                title="File Uploader"
                description="Upload and manage your files easily."
                icon={UploadIcon}
